...
orderBtn.addEventListener('click', () => {
  ...
  orderBtn.innerHTML = orderBtn.dataset.desc === 'desc' ? 
      '<span class="text-xs md:text-sm">Latest</span> <i class="fa-solid fa-arrow-up-wide-short"></i>' : 
      '<span class="text-xs md:text-sm">Earliest</span> <i class="fa-solid fa-arrow-down-wide-short"></i>';
  ...
  element.innerHTML = `
      <div class="flex items-center justify-between w-full">
          ...
          <div class="flex items-center gap-4">
              ...
              <button onclick="saveEdit(${order})" class="text-green-600 hover:text-green-800">📝</button>
              <button onclick="cancelEdit(${order})" class="text-red-600 hover:text-red-800">❌</button>
          </div>
      </div>
  `;
